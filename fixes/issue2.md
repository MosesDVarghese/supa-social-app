The next issue is `No +[RCTConvert WKDataDetectorTypes: ] function found.`

To fix this, locate the `RichEditor.js` file in `node_modules/react-native-pell-rich-editor/src/`
...
export default class RichTextEditor extends Component {
  ...
  renderWebView() {
    let that = this;
    const { html, editorStyle, useContainer, style, onLink, ...rest } =
      that.props;
